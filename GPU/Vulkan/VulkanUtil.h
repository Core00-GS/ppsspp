...
public:
	...
	VkDescriptorSet GetDescriptorSet(VkImageView image, VkBuffer buffer, VkDeviceSize bufferOffset, VkDeviceSize bufferRange, VkBuffer cbuffer, VkDeviceSize cbufferSize);
